  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h2 className="mt-1 text-xl font-semibold text-slate-800">{folder.name}</h2>
      ...
      <Card>
        <CardBody>
          <h3 className="mb-3 text-lg font-semibold text-slate-800">Files</h3>
          <form onSubmit={uploadFile} className="mb-4 grid grid-cols-1 gap-3 rounded-lg bg-slate-50 p-3 sm:grid-cols-4">
      ...
      <Card>
        <CardBody>
          <h3 className="mb-3 text-lg font-semibold text-slate-800">Tests</h3>
          <form onSubmit={createTest} className="mb-4 grid grid-cols-1 gap-3 rounded-lg bg-slate-50 p-3 sm:grid-cols-4">
